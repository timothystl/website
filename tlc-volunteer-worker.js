...
function navigate(pageId) {
  ...
  if (stickyBack) stickyBack.style.display = pageId === 'landing' ? 'none' : 'inline-flex';
}
...
function showThankYou(formEl) {
  formEl.innerHTML = '<div style="text-align:center;padding:2.5rem 1rem;">'
    ...
    + '<p style="font-size:.85rem;color:var(--text-muted);margin-top:.5rem;">Returning to home\\u2026</p>'
    + '</div>';
