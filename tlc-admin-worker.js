...
import { migrateLegacyPage, sanitizeBlocks, sanitizeBlock, parseBlocks, newBlock,
         ...
         STAMP_PRESETS, safeUrl, esc as escBlock, makeBlockId,
...
${PAYROLL_HTML}`, 'Payroll');
    ...
    // daily cron -- see admin/pages.js's own comment on handlePagesRoutes
    // for why this stays a parameter bag built here rather than its own
    // module, for now.
    {
      const editorShared = {
