...
- **No logo image upload for the top nav bar** — Dinger asked 2026-08-05 about adding the church logo to the top bar; today the header only supports the "T" initial badge shown in the Menu preview, no image field. Would need a new setting (e.g. under Settings or Menu) wired into the header template to support an uploaded logo image.
