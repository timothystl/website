...
export const VERSION = 'v4.28.0'; // minor: alignment is left/centre/right on every block but Spacer, buttons included, and giving-page ladder rows are edited on the Giving screen
