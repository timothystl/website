...
export const VERSION = 'v4.22.1'; // minor: /news is a real block-editor page (event re-sort, newsletter archive with preview collapse), half-width blocks read left-to-right again with stretch, Hero gets a real Alignment toggle
