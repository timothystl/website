...
export const VERSION = 'v5.57.0'; // minor: a Christmas Market vendor's row can switch how they are paying between card and check/cash (re-pricing the table), and the Square webhook now records what Square actually kept, so the coordinator can see what really deposits
