...
export const VERSION = 'v4.26.0'; // minor: a password is changed on its own screen - the access form has no password field for a password manager to fill, so editing permissions can no longer rewrite a username or a password
