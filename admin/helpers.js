...
export const VERSION = 'v5.41.3'; // patch: Year to date now backfills the total for periods approved before the rate-freeze fix shipped, instead of silently excluding them
