...
export const VERSION = 'v5.6.0'; // minor: the Christmas Market vendor application — a public three-step form that takes payment, and the coordinator's list that replaces the spreadsheet
