...
export const VERSION = 'v5.42.0'; // minor: Event Intake — a large window's read was silently truncated by D1's bound-parameter limit, so nothing ever looked assigned
