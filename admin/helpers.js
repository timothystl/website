...
export const VERSION = 'v4.24.0'; // minor: the CLAUDE.md backlog pass — EXIF stripped on upload (B6), session idle timeout (B5), gym slot locked by the database (B1), tap targets measured at 390px (B8), a settable social image (B7), this week's service on /sermons, and the block CSS font variables that were never defined
