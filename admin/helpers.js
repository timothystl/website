...
export const VERSION = 'v5.8.0'; // minor: the Bible classes block — /education, the page the menu calls Learn, was the other page whose content is filled at runtime
