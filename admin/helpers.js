...
export const VERSION = 'v5.6.0'; // minor: the published blocks are rendered into the HTML at the edge, so a page no longer paints its old hardcoded markup first
