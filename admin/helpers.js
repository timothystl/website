...
export const VERSION = 'v5.14.0'; // minor: the nine Christmas Market settings, none of which had anywhere to be set — the fund ID on the Giving tab, the rest on Settings
