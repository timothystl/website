...
export const VERSION = 'v5.32.1'; // minor: the escaping sweep — every plain-text field in the newsletter email and the public renderer is escaped, escText is attribute-safe, the gym's four partial escapes are gone, and the document title is escaped at the sink
