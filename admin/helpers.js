...
export const VERSION = 'v4.15.3'; // minor: review batches 2-4 — half blocks stack and centre, one marker read, edge-cached /api/pages, badges everywhere, one series fetch
