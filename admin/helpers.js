...
export const VERSION = 'v5.39.1'; // minor: the printed calendar had no fallback for a browser without :has(), and the list view's time range could overlap its own title
