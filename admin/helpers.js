...
export const VERSION = 'v4.31.0'; // minor: rich fields open on demand — the page editor used to build one editor per rich field and rebuild all of them on every nudge
