...
export const VERSION = 'v5.56.2'; // minor: /voters is fully editable ordinary blocks now (Callout/Button bar/Documents), backfilled once from the old bespoke /voters screen, which is retired
