...
export const VERSION = 'v5.54.0'; // minor: a "No shading" option, two lighter banner colors, and a countdown that can target the office's own words and date instead of only a News & Events post
