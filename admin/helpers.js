...
export const VERSION = 'v5.25.1'; // minor: the Christmas Market generalizes into a real Events section — any number of events, each with optional registration/payment/volunteers/photos
