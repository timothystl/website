...
export const VERSION = 'v5.62.15'; // minor: every staff email on the public site is obfuscated the same way the market coordinator's is, except office@ and dinger@ — Buttons, Card grid, Link tiles, Welcome banner slides, the Contact details block's own override, and any mailto typed straight into rich text
