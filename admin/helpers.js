...
export const VERSION = 'v5.55.0'; // minor: /voters is a block-editor page now — hero + a self-filling votersinfo block reading the same voters_page record the bespoke /voters screen already edits
