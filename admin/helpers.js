...
export const VERSION = 'v5.58.0'; // minor: a paid card row Square has not reported a real fee for shows an estimate instead — worded so it is never mistaken for Square's own confirmed figure
