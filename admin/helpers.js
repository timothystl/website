...
export const VERSION = 'v5.39.1'; // patch: Year to date now backfills the total for periods approved before the rate-freeze fix shipped, instead of silently excluding them
