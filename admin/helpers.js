...
export const VERSION = 'v4.23.4'; // minor: the header and the newsletter band are editable from Menu -> Appearance, drafted then published; the Menu preview now draws the real bar instead of an invented one
