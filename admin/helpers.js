...
export const VERSION = 'v5.7.0'; // minor: the Christmas Market vendor application — a public three-step form that takes payment, and the coordinator's list that replaces the spreadsheet
