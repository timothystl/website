...
export const VERSION = 'v5.30.0'; // minor: the Christmas Market vendor row is the form — inline editing, sorting, a category and check tracking — and the volunteer roster is four printable views
