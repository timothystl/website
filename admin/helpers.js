...
export const VERSION = 'v5.43.1'; // minor: Event Intake checklist ticks show live and sit above the fold; the print calendar says "+N more" instead of clipping; the calendar's Source filter is retired
