...
export const VERSION = 'v5.5.1'; // minor: Dinger's ten — text size, the calendar, a Contact block, per-block email, block edges, give funds, clickable cards, a section sidebar, info tiles, and the hero inset
