...
export const VERSION = 'v5.27.4'; // minor: a new event can adopt an already-existing page (VBS and the rest of Youth & Family) instead of getting a second one; an already-created event can connect to, or disconnect from, a page too
