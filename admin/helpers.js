...
export const VERSION = 'v5.49.0'; // minor: the Christmas Market has a real table cap now — 60 confirmed, then a soft reserve to 70, plus a manual door for unpaid church ministries
