...
export const VERSION = 'v5.53.0'; // minor: the market's Volunteer sign-ups toggle now opens/closes Serve itself, not just the local Volunteers tab — see setSignupsOpen() in admin/market.js
