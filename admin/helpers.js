...
export const VERSION = 'v4.25.1'; // minor: give.timothystl.org is a block-editor page - two new self-filling block types that compute every Tithe.ly link at render time and can never store one
