...
export const VERSION = 'v5.52.0'; // minor: the Media screen's Upload and Edit buttons go somewhere now — /media/upload and /media/edit/:id were never routed, so both fell through to the newsletter dashboard
