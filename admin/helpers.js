...
export const VERSION = 'v5.28.3'; // minor: a block's stamp can be sized Large, centered instead of corner-only, made to pulse for attention, and typed directly in the panel
