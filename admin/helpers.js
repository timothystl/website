...
export const VERSION = 'v5.38.1'; // minor: the calendar palette's contrast — seven of twelve category colors failed WCAG AA and the test the code claimed checked this never existed
