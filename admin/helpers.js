...
export const VERSION = 'v4.24.0'; // minor: give.timothystl.org is a block-editor page - two new self-filling block types that compute every Tithe.ly link at render time and can never store one
