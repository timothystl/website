...
export const VERSION = 'v5.10.0'; // minor: the chrome arrives already painted too — the header, logo and newsletter band were still swapped in after a round trip
