...
export const VERSION = 'v4.30.2'; // minor: the payroll exports are back to the format the bookkeeper has always had — MDO first, church allowance columns, one printed page
