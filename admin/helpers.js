...
export const VERSION = 'v5.0.0'; // MAJOR: the site redesign — one typeface setting moving every page, the chrome, four new block shapes, and four authored page drafts
