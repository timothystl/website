...
export const VERSION = 'v5.59.0'; // minor: a fifth "Net deposited" tile on the Christmas Market vendor list, so a card fee is visible at a glance instead of buried in each row's own fine print
