...
export const VERSION = 'v5.48.2'; // minor: a stale newsletter save can no longer silently overwrite somebody else's — a conflict lands in its own recovery draft instead
