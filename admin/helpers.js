...
export const VERSION = 'v5.60.1'; // minor: the Christmas Market coordinator's email is no longer plain-text scrapeable off the public pages, /api/market-config, or the market application's own form config
