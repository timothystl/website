...
export const VERSION = 'v5.31.0'; // minor: the classic rich fields are sanitized (FX-04), Turnstile can be switched on safely (FX-05), the 85KB block stylesheet is a cacheable asset (FX-17), and the /api/pages cache chokepoint covers what actually feeds it (FX-19)
