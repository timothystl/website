...
export const VERSION = 'v5.7.0'; // minor: the Sermon library block — /sermons had no block that could show a sermon — and the auto-bump stops overwriting a version somebody chose
